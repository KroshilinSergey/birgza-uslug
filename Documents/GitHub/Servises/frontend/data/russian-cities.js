// russian-cities.js - расширенная база городов России
(function (global) {
  // Данные о городах (название, регион, население)
  // Источник: https://github.com/pensnarik/russian-cities (адаптировано)
  const citiesData = [
    {
      coords: {
        lat: "52.65",
  ...
  class RussianCities {
    ...
    // Поиск городов по подстроке (без учёта регистра)
    search(query) {
  ...
  global.RussianCities = new RussianCities();
})(window);
